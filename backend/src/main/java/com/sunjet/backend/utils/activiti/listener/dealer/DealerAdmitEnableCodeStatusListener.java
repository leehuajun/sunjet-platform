 ...
 */
@Component("dealerAdmitEnableCodeStatusListener")
public class DealerAdmitEnableCodeStatusListener implements TaskListener {
    @Autowired
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        dealerAdmitRequest.setCanEditCode(true);

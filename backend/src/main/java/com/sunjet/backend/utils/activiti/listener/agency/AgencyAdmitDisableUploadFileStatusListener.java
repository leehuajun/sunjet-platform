 ...
 */
@Component("agencyAdmitDisableUploadFileStatusListener")
public class AgencyAdmitDisableUploadFileStatusListener implements TaskListener {
    @Autowired
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        admitRequest.setCanUpload(false);  // 切换状态

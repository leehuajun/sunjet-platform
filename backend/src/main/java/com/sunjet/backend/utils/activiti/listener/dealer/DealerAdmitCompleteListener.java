...
//    }
    ...
    public void notify(DelegateExecution execution) throws Exception {
        ...
        DealerAdmitRequestEntity admitRequest = dealerAdmitRepostitory.findOne(businessId);
        // 3. 获取业务对象的某个属性
        DealerEntity dealerEntity = dealerRepository.findOne(admitRequest.getDealer());

 ...
 */
@Component("agencyAdmitEnableCodeStatusListener")
public class AgencyAdmitEnableCodeStatusListener implements TaskListener {
    @Autowired
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        admitRequest.setCanEditCode(true);  // 切换状态

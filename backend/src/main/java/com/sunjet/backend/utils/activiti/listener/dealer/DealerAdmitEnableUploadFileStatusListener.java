 ...
 */
@Component("dealerAdmitEnableUploadFileStatusListener")
public class DealerAdmitEnableUploadFileStatusListener implements TaskListener {
    @Autowired
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        dealerAdmitRequest.setCanUpload(true);  // 切换状态

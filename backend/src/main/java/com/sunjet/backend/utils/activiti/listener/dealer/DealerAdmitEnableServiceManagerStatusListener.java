 ...
 */
@Transactional
@Component("dealerAdmitEnableServiceManagerStatusListener")
public class DealerAdmitEnableServiceManagerStatusListener implements TaskListener {
    @Autowired
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        dealerAdmitRequest.setCanEditServiceManager(true);  // 切换状态

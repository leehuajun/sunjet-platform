...
@Entity
@Immutable
@Subselect("select obj_id,doc_no,dealer_code,dealer_name,created_time,expense_total,operator,operator_phone,process_instance_id,status,service_manager from asm_dealer_settlement_docs")
public class DealerSettlementView implements Serializable {

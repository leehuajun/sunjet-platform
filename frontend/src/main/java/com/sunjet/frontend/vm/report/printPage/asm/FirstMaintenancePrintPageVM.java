 ...
 */
public class FirstMaintenancePrintPageVM {
    ...
    public void init() {
        ...
        this.reportUrl = "/views/report/printPage/asm/firstMaintenancePrintPage.jsp?objId=" + objId
                + "&printType=firstMaintenance.jasper";

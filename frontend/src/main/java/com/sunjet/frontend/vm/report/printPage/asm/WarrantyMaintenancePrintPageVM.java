 ...
 */
public class WarrantyMaintenancePrintPageVM {
    ...
    public void init() {
        ...
        String printType = Executions.getCurrent().getArg().get("printType").toString();
        ZkUtils.setSessionAttribute("restClient", restClient);

        this.reportUrl = "/views/report/printPage/asm/warrantyMaintenancePrintPage.jsp?objId=" + objId
                + "&printType=" + printType;
    }

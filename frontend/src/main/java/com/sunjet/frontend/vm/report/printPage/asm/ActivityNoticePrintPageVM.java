 ...
 */
public class ActivityNoticePrintPageVM {
    ...
    public void init() {
        ...
        String printType = "activityNotices.jasper";
        ZkUtils.setSessionAttribute("restClient", restClient);
        this.reportUrl = "/views/report/printPage/asm/activityNoticePrintPage.jsp?objId=" + objId
                + "&printType=" + printType;

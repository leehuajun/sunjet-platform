 ...
 */
public class FreightSettlementPrintPageVM {
    ...
    public void init() {
        ...
        this.reportUrl = "/views/report/printPage/settlement/freightSettlementPrintPage.jsp?" +
                "objId=" + objId
                + "&docNum=" + docNum
                + "&dealerPhone=" + dealerPhone
                + "&serviceManagerName=" + serviceManagerName
                + "&printType=freightSettlement.jasper";

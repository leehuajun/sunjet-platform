 ...
 */
public class FreightSettlementDetailVM {
    ...
    public void init() {
        ...
        this.reportUrl = "/views/report/printPage/settlement/freightSettlementDetail.jsp?" +
                "objId=" + objId
                + "&startDate=" + startDate
                + "&endDate=" + endDate
                + "&printType=freightSettlementDetail.jasper";

 ...
 */
public class DealerSettlementDetailVM {
    ...
    public void init() {
        ...
        this.reportUrl = "/views/report/printPage/settlement/dealerSettlementDetail.jsp?" +
                "objId=" + objId
                + "&startDate=" + startDate
                + "&endDate=" + endDate
                + "&printType=dealerSettlementDetail.jasper";
